...
const createMessageDiv = (messageId, message) => {
  ...
  if(dbdata.favorites[messageId]) {
    divTag.find('div i').addClass('fa-star');
    divTag.find('div i').removeClass('fa-star-o');
  };
...
const loadChatView = () => {
  ...
  favoritesRef.on('child_removed', (favSnapshot) => {
    ...
    $(`#message-id-${messageId} i`).addClass('fa-star-o');
    $(`#message-id-${messageId} i`).removeClass('fa-star');
  ...
  favoritesRef.on('child_added', (favSnapshot) => {
    ...
    $(`#message-id-${messageId} i`).removeClass('fa-star-o');
    $(`#message-id-${messageId} i`).addClass('fa-star');
